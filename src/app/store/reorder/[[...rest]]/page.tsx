...
// RETIRED: /store/reorder -> /store/stock/reorder
//
// A catch-all, not a bare page: the reorder chips were real URLs and are
...
export default async function Page({
  ...
  await goLegacy(`/store/reorder${rest.length > 0 ? `/${rest.join('/')}` : ''}`, await searchParams)
}
