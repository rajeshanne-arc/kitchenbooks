    ...
    <div className="mt-4 space-y-4">
      ...
      {issue.is_voided && voidedBy !== null && (
        <div className="rounded-xl border border-red-200 bg-red-50 p-3 text-sm text-red-800">
          ...
          <Link href={`/store/books/issues/${voidedBy.id}`} className="font-medium underline">
            its reversal
          </Link>{' '}
      ...
      {issue.is_reversal && issue.reverses_id !== null && (
        <div className="rounded-xl border border-violet-200 bg-violet-50 p-3 text-sm text-violet-800">
          ...
          <Link href={`/store/books/issues/${issue.reverses_id}`} className="font-medium underline">
            the original issue
          </Link>
