// The kitchen group. LAW 3: the tab strip is resolved once here — settings-ordered,
...
export default async function KitchenGroupLayout({ children }: { children: React.ReactNode }) {
