  ...
  return (
    <>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {/* 1 — yesterday */}
        <Card title="Yesterday" source="sales_by_day · day_close_ladder" href="/sales/books/sales">
        ...
        {/* 2 — month by section */}
        <Card title="This month by section" source="section_costs" href="/kitchen/books/sections">
        ...
        {/* 3 — food cost % */}
        <Card title="Food cost % by section" source="section_food_cost" href="/kitchen/books/food-cost">
          {fcRows.length === 0 ? (
        ...
        {/* 4 — owed */}
        <Card title="Owed" source="vendor_dues · owners_owed" href="/store/masters/vendors">
        ...
        {/* 6 — waste */}
        <Card title="Waste this month" source="wastage · kitchen_wastage" href="/store/books/log">
        ...
        {/* 7 — stock alarms */}
        <Card title="Stock alarms" source="stock_on_hand" href="/store/books/stock" alert={alarms.length > 0}>
          {alarms.length === 0 ? (
        ...
        <Card title="Unknown POS statuses" source="sales_current" href="/sales/books/sales" alert={unknownCount > 0}>
          {unknownCount === 0 ? (
        ...
        {/* 9 — days not closed */}
        <Card title="Days not closed" source="missing_closes" href="/sales" alert={missing.length > 0}>
          {missing.length === 0 ? (
        ...
        {/* 10 — staff */}
        <Card title="Staff" source="staff · attendance_current" href="/staff/people/attendance">
          <p className="text-sm text-stone-600">
