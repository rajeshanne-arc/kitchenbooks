// The owner group. LAW 3: the tab strip is resolved once here — settings-ordered,
...
export default async function OwnerGroupLayout({ children }: { children: React.ReactNode }) {
